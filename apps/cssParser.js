...
(function loadLib() {
    ...
    try {
        ...
        apps.cssParser.CSSParser.type = 'apps.cssParser.CSSParser';
        apps.cssParser.CSSParser.categories = {};
        apps.cssParser.CSSParser.prototype.constructor = apps.cssParser.CSSParser;
    } catch(e) {
