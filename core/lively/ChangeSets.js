...
(function setupBaseExtensionsForContextPath() {
    ...
    ["Global", "Intl.Collator", "Intl.DateTimeFormat", "Intl.NumberFormat", "console", "location", "JSON", "Math"].each(function(e){
...
'default category', {
    ...
    initialize: function(text1, text2, styleSpec1, styleSpec2, optExtraTexts) {
        ...
        diffList.each(function(e) {
            ...
            if (e.added) {
                i = whitespace[string2][0].indexOf(index2);
                if(i > -1 && whitespace[string2][1][i] == e.value.length)
            ...
            if (e.removed) {
                i = whitespace[string1][0].indexOf(index1);
                if(i > -1 && whitespace[string1][1][i] == e.value.length)
...
lively.morphic.Panel.subclass('FunctionListBrowser',
'default category', {
    buildView: function buildView() {  // this.buildView()
        this.withAllSubmorphsDo(function(m) {disconnectAll(m)});
        this.removeAllMorphs();
...
Object.subclass('ReferencesCycler',
'default category', {
...
Object.extend(Global, {
    ...
    nonClassConstructors: function(recursive) {
        ...
        Object.getOwnPropertyNames(this).each(function(name) {
            ...
            if (!this.__lookupGetter__(name) &&
                ...
                object.lvIsConstructor()) {
                    result.push(object);
                    if(!object.lvContextPath() || lively.lookup(object.lvContextPath()) !== object)
                        addOwnPropertyIfAbsent(object, 'lvContextPath', function(){return name;});
                    if(!object.prototype.lvContextPath() || lively.lookup(object.prototype.lvContextPath()) !== object.prototype)
    ...
    printInContext: function(aFunctionName, context) {
        var annotation = "// doitContext = " + context.lvContextPath() + "\n";
