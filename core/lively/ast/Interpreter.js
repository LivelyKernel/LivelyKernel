module('lively.ast.Interpreter').requires('lively.ast.acorn').toRun(function() {
...
(function extendAcorn() {
    ...
    */
    acorn.walk.interpret = function acornWalkInterpret(ast, frameOrMapping) {
        var currentFrame;
        if (frameOrMapping instanceof lively.ast.Interpreter.Frame)
            var currentFrame = frameOrMapping;
        else
            var currentFrame = lively.ast.Interpreter.Frame.create(null, frameOrMapping);
