...
lively.BuildSpec('lively.ide.tools.EntanglementInspector', {
    ...
    _Position: lively.pt(572.5,64.5),
    ...
    listListener: "AttributeConnection([object Object].createEntangledMorph --> <lively.morphic.List#50E92... - EntangledMorphsList>.addItem)",
    ...
    addMethodToTree: function addMethodToTree(treeItem, entanglement, name, method, itemAfter) {
        ...
        var editor = new lively.ide.newCodeEditor(pt(0).extent(pt(400,loc * 22)), source );
        ...
        editor.enableGutter();
        editor.aceEditor.getSession().foldAll();
        ...
        function onFold(fold) {
            ...
            var height = expanding ? (fold.data.end.row - fold.data.start.row) * 22 + 10: 22;
