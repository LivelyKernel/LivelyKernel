...
lively.morphic.SAPUI5.Component.subclass('lively.morphic.SAPUI5.OldControls.TextField',
...
'HTML', {
    ...
    setupButtonNodeHTML: function(ctx){
         ctx.buttonNode= XHTMLNS.create('div');
          ...
          var cb = this;
          $(ctx.buttonNode).click(function (evt) {cb.showListBox();});
    },
    appendHTML: function($super, ctx, optMorphAfter) {
    ...
    getComponentBoundsHTML: function(ctx) {
        ...
        var height = $(ctx.componentNode).outerHeight();
        var width = $(ctx.componentNode).outerWidth();        
...
'event handling', {
    showListBox: function() {
        ...
        var r = b.withY(b.y + b.height).withHeight(30);
...
'init', {
    ...
    resizeListHTML: function(ctx) {
        ...
        listNode.style.top = this.shape.getPosition().y /*+ this.padding.top()*/ + 'px';
        listNode.style.width = extent.x /*- this.padding.right() - this.padding.left())*/ + 'px';
        listNode.style.maxHeight = this.maxHeight /*- this.padding.bottom() - this.padding.top()*/ + 'px';
    },
},
...
'events', {
    ...
    onClick: function($super, evt) {
        $super(evt);
        console.log("onClick, selected Item:");
        console.log(this.getSelectedItem());
        this.remove();
    },    
    selectAt: function($super, idx){
        $super(idx);    
        console.log("selectAt, selected Item:");
        console.log(this.getSelectedItem());
