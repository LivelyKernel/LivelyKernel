module('lively.morphic.SAPWorkSheet').requires('lively.morphic.Core', 'lively.morphic.Events', 'lively.WidgetsTraits', 'lively.morphic.Styles').toRun(function() {
...
'initialization', {
    ...
    initializeScrolls: function() {
        ...
        this.hScroll  = new lively.morphic.Slider(new Rectangle(0,nHeight + this.defaultCellHeight , nXPos,15), 100);
 ...
 showAnnotation: function(nColumn,nRow) {
    ...
    setData: function(aJsArray) {
        ...
        */
        ...
        this.vScroll.setValue(this.arrData.length);
