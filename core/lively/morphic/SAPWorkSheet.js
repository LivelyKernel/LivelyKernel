...
'default category', {
    initialize: function($super,oGrid, nXpos, nYpos,nWidth,nHeight) {
        ...
        this.imgCopy= new lively.morphic.Image(new Rectangle(nGapGroupWidth + 24*3 + 10 + 4*nGapWidth,30,24,24), "images/Actions-edit-copy-icon.png"); 
...
'default category', {
    initialize: function($super, numCols, numRows) {
     ...
     initializeLayout: function() {
        ...
        this.grid.setPosition(pt(0,this.toolBarHeight));
