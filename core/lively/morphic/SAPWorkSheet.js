...
'default category', {
    initialize: function($super,oGrid, nXpos, nYpos,nWidth,nHeight) {
        ...
        this.imgRemoveColumn = new lively.morphic.Image(new Rectangle(5*nGapGroupWidth + 25*17 + 10 + 13*nGapWidth,nSecondLineYPos,24,24), "images/table-column-delete-icon.png");
