...
//imgClear
    ...
    imgClear_Click: function() {
        debugger;
        if (this.oClearMenu){
            this.oClearMenu.openInWorld(this.imgClear.getPositionInWorld().addXY(2, 2));
        }else{
	    ...
	    var arrItems=[];
            ...
            this.oClearMenu= lively.morphic.Menu.openAt(this.imgClear.getPositionInWorld().addXY(2, 2), null, arrItems);
        }
    },
