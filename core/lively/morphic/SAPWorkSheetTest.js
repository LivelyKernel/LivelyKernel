...
'initialization', {
   initialize: function($super, numCols, numRows,bHideColHeader,bHideRowHeader) {
        ...
        this.colHeads = [];     //holding column headers
        this.rowHeads = [];     //holding row headers    
...
'Other Methods', { 
    ...
    updateColumnDisplay: function(evt) {
        ...
        if (this.prviousScrollColValue!=nScrollValue){
            ...
            //column name
            for (var nCol = this.startColumn+1; nCol < this.endColumn; nCol++) {
    ...
    moveActiveCellBy: function(evt,aPoint) {
        ...
        var nNumofVisibleRow =  this.getNumofVisibleRow()+1;
        var nNumofVisibleColumn = this.getNumofVisibleColumn()+1;     
...
//debugger;
	...
	this.grid.showAnnotation(this.gridCoords.x,this.gridCoords.y);
    },
...
'setExtent', {
    setExtent: function ($super,oPos) {
        ...
        //if width can't be smaller than 60
        if (oPos.x < 60){
            oPos.x=60;
        }
        
        this.cellWidth = oPos.x;  //saving cell width 
        //saving column width in arrData[0] as cellWidth parameter
        if (this.grid){
