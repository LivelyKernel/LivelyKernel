...
'testing', {
    ...
    testMorphSelectBySiblingRelation: function() {
        ...
        this.assertEqualState([this.redRectangle, this.blueRectangle1], selection, 'selection by sibling relation should include only red rectangle and blue rectangle 1');
